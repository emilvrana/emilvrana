...
- [The Default Bias: Why Your Agent Chooses the Obvious](./posts/the-default-bias.md) — LLMs default to the most common pattern in their training data. In production agents, this isn't a feature — it's a bug.
